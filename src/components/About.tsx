      ...
      <div className="flex flex-col justify-center items-center h-full  space-y-8">
        ...
        <div className="lg:w-2/3 mx-auto grid lg:grid-cols-2">
          <div className="p-3 text-sm lg:text-xl text-justify">
            ...
            maintain code. Now a days I am learning about Cloud Computing and on
            a journey to be a <span className="font-bold">DevOps</span>{" "}
            ...
            {education.map((item) => (
              ...
              >
                ...
                <div className="flex flex-col items-end">
                  ...
                  <p className="font-bold md:text-lg font-mono">{item.year}</p>
                </div>
              </div>
            ))}
          </div>
